...
Route::group(['middleware' => ['auth', 'verified', 'istrader']], function() {
    ...
    Route::post('trader-update-password', [App\Http\Controllers\UserController::class, 'updatePassword']);
    Route::post('/transfer', [App\Http\Controllers\TransferController::class, 'store']);

    Route::post('/request-payment', [App\Http\Controllers\PaymentToAdminController::class, 'requestPayment']);
