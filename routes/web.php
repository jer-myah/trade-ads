...
Route::get('/adverts-by-category/{category_id}', [App\Http\Controllers\AdvertController::class, 'showByCategory']);
...
Route::group(['middleware' => ['auth', 'verified',]], function(){
    Route::post('/update-avatar', [App\Http\Controllers\UserController::class, 'updateAvatar']);
});
