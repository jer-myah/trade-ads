    ...
    <div class="flex flex-wrap bg-gray-100 w-full h-full">
        <div class="w-full bg-white rounded p-3 shadow-sm" style="background: #AD8B63 ">
            ...
            <div class="flex border-t items-center space-x-4 p-2 my-5">                
                <img v-if="$page.props.auth.user.avatar" class="h-12 rounded-full" :src="'storage/'+$page.props.auth.user.avatar" alt="User Avatar">
                <div>
                    ...
                    <span class="text-sm tracking-wide flex items-center space-x-1">
                        ...
                        </svg><span class="text-white">Verified</span>
                    </span>
                </div>
            </div>
            <ul class="space-y-2 text-sm">
                ...
                <li class="transition ease-out duration-200 transform hover:scale-110">
                    <a href="/user-adverts" class="flex items-center space-x-3 text-gray-700 p-2 rounded-md font-medium hover:bg-gray-200 focus:bg-gray-200 focus:shadow-outline">
                        <span class="text-gray-600">
                            <svg class="h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <li class="transition ease-out duration-200 transform hover:scale-110">
                    <a href="/profile-information" class="flex items-center space-x-3 text-gray-700 p-2 rounded-md font-medium hover:bg-gray-200 focus:bg-gray-200 focus:shadow-outline">
                        <span class="text-gray-600">
                            <svg class="h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4"></path>
                            </svg>
