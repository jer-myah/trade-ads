            ...
            <div class="flex flex-col py-8">
                ...
                <div class="w-10/12 mx-auto pb-8 pt-5 bg-gray-200 shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                    <div class="w-4/5 mx-auto py-5">
                        <Label class="uppercase font-bold font-sans text-xl text-gray-100" value="Create Package" />
                    </div>
                        ...
                        <div class="mt-4">
                            ...
                            <div class="flex justify-around">
                                <div class="flex">
                                    ...
                                    <Input id="photo" type="radio" name="photo" :checked="advert_package.photo==1" class="mt-1 px-3" v-model="form.photo" />
                                </div>
                                <div class="flex">
                                    <Label for="photo" value="No" class="mx-3" />
                                    <Input id="photo" type="radio" name="photo" :checked="advert_package.photo==0" class="mt-1 px-3" v-model="form.photo" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mt-4">
                            ...
                            <div class="flex justify-around">
                                <div class="flex">
                                    ...
                                    <Input id="media" type="radio" name="media" :checked="advert_package.media==1" class="mt-1 px-3" v-model="form.media" />
                                </div>
                                <div class="flex">
                                    <Label for="media" value="No" class="mx-3" />
                                    <Input id="media" type="radio" name="media" :checked="advert_package.media==0" class="mt-1 px-3" v-model="form.media" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mt-4">
                            ...
                            <div class="flex justify-around">
                                <div class="flex">
                                    ...
                                    <Input id="ads_link" type="radio" name="ads_link" :checked="advert_package.adslink==1" class="mt-1 px-3" v-model="form.ads_link" />
                                </div>
                                <div class="flex">
                                    <Label for="ads_link" value="No" class="mx-3" />
                                    <Input id="ads_link" type="radio" name="ads_link" :checked="advert_package.adslink==0" class="mt-1 px-3" v-model="form.ads_link" />
                                </div>
                            </div>
                        </div>
