                    ...
                    <div class="w-full  max-w-lg p-5 relative mx-auto my-auto rounded-xl shadow-lg  bg-white ">
                        <div class="">
                            <div class="text-center p-5 flex-auto justify-center">
                                ...
                                <h2 class="text-xl font-bold py-4 ">Select Option</h2>
                                <select v-model="form.shared" class="text-sm text-gray-500 px-8 focus:border-gray-500">
                            ...
                            <!--footer-->
                            <div class="p-3  mt-2 text-center space-x-4 md:block">
                                <button @click="form.id = '', share_modal = false" class="mb-2 md:mb-0 bg-white px-5 py-2 text-sm shadow-sm font-medium tracking-wider border text-gray-600 rounded-full hover:shadow-lg hover:bg-gray-100 focus:outline-none transition ease-out duration-200 transform hover:scale-110">
                                    Cancel
                                </button>
                                <button @click="shareLink" class="mb-2 md:mb-0 bg-green-500 border border-green-500 px-5 py-2 text-sm shadow-sm font-medium tracking-wider text-white rounded-full hover:shadow-lg hover:bg-green-600 focus:outline-none transition ease-out duration-200 transform hover:scale-110">
                                    Share
                                </button>
                            </div>
                        </div>
