                ...
                <dl>
                    <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                        ...
                        <dd class="mt-1 text-sm text-gray-600 sm:mt-0 sm:col-span-2">
                            <BreezeInput v-model="password_form.old_password" type="password" required></BreezeInput>
                        </dd>
                    </div>
                    <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                        <dt class="text-sm font-medium text-gray-500">
                        ...
                        <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                            <BreezeInput v-model="password_form.password" type="password" required></BreezeInput>
                        </dd>
                    </div>
                    <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                        <dt class="text-sm font-medium text-gray-500">
                        ...
                        <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                            <BreezeInput v-model="password_form.password_confirmation" type="password" required></BreezeInput>
    ...
    methods: {
        changePassword(){
            if(this.password_form.password === this.password_form.password_confirmation){
                this.$inertia.post('/trader-update-password', this.password_form, {
                    onFinish: () => {
