            ...
            <div v-if="show_form" class="flex flex-col py-8">
                ...
                <div class="w-10/12 mx-auto pb-8 pt-5 bg-gray-200 shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                    ...
                    <form @submit.prevent="submit" class="w-3/5 mx-auto py-5">
                        ...
                        <div class="mt-4">
                            <Label for="price" value="Advert Price" />
                            <Input id="price" type="numeric" class="mt-1 px-3 block w-full" v-model="form.price" required autocomplete="price" />
                        </div>
                        ...
                        <div class="mt-5">
                            <Label for="image" value="Optional Image" />
                            <Input id="image" type="file" @input="form.image_1 = $event.target.files[0]" class="mt-1 block w-full" />
                        </div>

                        <div class="mt-5">
                            <Label for="image" value="Optional Image" />
                            <Input id="image" type="file" @input="form.image_2 = $event.target.files[0]" class="mt-1 block w-full" />
                        </div>
