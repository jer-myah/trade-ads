<template>
    <div class="flex flex-col sm:justify-center items-center pt-6 sm:pt-0" :style="{ backgroundImage: 'url('+bg_image+')' }">
                ...
                <div class="flex justify-end items-center relative">
                    ...
                    <div class="flex mr-4 items-center">
                        <a class="inline-block py-2 px-3 hover:bg-gray-200 rounded-full" href="#">
                            <div @click="show_modal = !show_modal" class="flex items-center relative cursor-pointer whitespace-nowrap">Become a Trader</div>
                        </a>
        ...
        <div class="w-11/12 mx-auto md:w-9/12 lg:w-6/12 my-16 p-16 bg-white shadow-md overflow-hidden sm:rounded-lg">
            <slot />
        </div>
    </div>
</template>
...
<script>
    ...
    export default {
        ...
        data () {
            return {
                bg_image: '/public/images/login-background.jpg'
            }
        }
